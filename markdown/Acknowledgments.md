...
Source: https://lean-lang.org/functional_programming_in_lean/Acknowledgments
...
이 무료 온라인 책은 이것이 작성되고 배포되도록 비용을 지불한 Microsoft Research의 관대한 지원으로 가능했습니다.
저술 과정 동안, 그들은 Lean 개발 팀의 전문 지식을 내 질문에 답변하고 Lean을 사용하기 쉽게 만들기 위해 제공했습니다.
특히, Leonardo de Moura는 프로젝트를 시작했고 저를 도와주었고, Chris Lovett은 CI와 배포 자동화를 설정했으며 테스트 읽기 위원으로 훌륭한 피드백을 제공했고, Gabriel Ebner은 기술 검토를 제공했고, Sarah Smith는 행정 측면을 잘 운영했으며, Vanessa Rodriguez는 소스 코드 강조 라이브러리와 iOS의 특정 버전의 Safari 간의 복잡한 상호 작용을 진단하는 데 도움을 주었습니다.
...
이 책을 쓰는 것은 정상 근무 시간 외에 많은 시간을 소요했습니다.
제 아내 Ellie Thrane Christiansen은 가족을 돌보는 데 평소보다 더 많은 역할을 맡았고, 그녀가 그렇게 하지 않았다면 이 책은 존재할 수 없었을 것입니다.
매주 추가 하루의 작업은 제 가족에게 쉽지 않았습니다. 제가 쓸 때 인내심과 지원해 주셔서 감사합니다.
