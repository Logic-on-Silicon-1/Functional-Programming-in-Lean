...
[overloaded addition](Overloading-and-Type-Classes/Positive-Numbers/#overloaded-addition) 섹션에서 언급했듯이, Lean은 heterogeneous하게 덧셈을 overload하기 위한 `HAdd`라는 type class를 제공합니다.
...
[polymorphism의 초기 설명](Getting-to-Know-Lean/Polymorphism/#polymorphism)에서 논의했듯이, metavariable들은 추론할 수 없었던 프로그램의 알 수 없는 부분을 나타냅니다.
