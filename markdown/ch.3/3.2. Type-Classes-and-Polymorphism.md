...
[polymorphism에 대한 섹션](Getting-to-Know-Lean/Polymorphism/#polymorphism)은 다형적 point 타입을 제시했습니다:
...
이는 type class의 각 매개변수가 instance 이전에 나타나는 메서드의 매개변수여야 함을 의미합니다.
...
이는 암묵적 매개변수 `n`을 파악하려고 할 때 Lean이 사용할 정보가 없다는 것을 의미합니다.
