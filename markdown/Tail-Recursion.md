...
Source: https://lean-lang.org/functional_programming_in_lean/Programming___-Proving___-and-Performance/Tail-Recursion

# 8.1. Tail Recursion[🔗](find/?domain=Verso.Genre.Manual.section&name=tail-recursion "Permalink")
...
## 8.1.1. Tail and Non-Tail Positions[🔗](find/?domain=Verso.Genre.Manual.section&name=tail-positions "Permalink")
...
## 8.1.2. Reversing Lists[🔗](find/?domain=Verso.Genre.Manual.section&name=reversing-lists-tail-recursively "Permalink")
...
## 8.1.3. Multiple Recursive Calls[🔗](find/?domain=Verso.Genre.Manual.section&name=multiple-call-tail-recursion "Permalink")
...
## 8.1.4. Exercises[🔗](find/?domain=Verso.Genre.Manual.section&name=tail-recursion-exercises "Permalink")
