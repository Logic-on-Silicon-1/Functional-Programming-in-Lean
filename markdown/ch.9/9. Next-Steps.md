...
Source: https://lean-lang.org/functional_programming_in_lean/Next-Steps
...
이 책은 Lean에서 함수형 프로그래밍의 가장 기본적인 내용을 소개하며, 약간의 대화형 정리 증명을 포함합니다.
Lean과 같은 종속 타입 함수형 언어를 사용하는 것은 깊이 있는 주제이며, 많은 내용을 말할 수 있습니다.
당신의 관심에 따라, 다음 리소스들이 Lean 4를 배우는 데 유용할 수 있습니다.
...
그러나 Lean을 계속 배우는 가장 좋은 방법은 코드를 읽고 쓰기 시작하고, 막힐 때 문서를 참고하는 것입니다.
또한, [Lean Zulip](https://leanprover.zulipchat.com/)은 다른 Lean 사용자를 만나고, 도움을 요청하고, 다른 사람을 돕는 훌륭한 장소입니다.
