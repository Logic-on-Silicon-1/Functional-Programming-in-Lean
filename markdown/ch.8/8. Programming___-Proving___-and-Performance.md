...
이 알고리즘은 종료되지만, Lean이 자동으로 확인할 수는 없습니다.
증명을 사용하여 프로그램이 종료되는 이유를 보여줄 수 있습니다.
...
프로그램을 더 빠르게 하기 위해 다시 작성하면 종종 이해하기가 더 어려운 코드가 생깁니다.
증명은 두 프로그램이 다양한 알고리즘이나 구현 기술을 사용하더라도 항상 동일한 답을 계산한다는 것을 보여줄 수 있습니다.
이렇게 하면, 느리고 간단한 프로그램이 빠르고 복잡한 버전의 사양으로 작용할 수 있습니다.
...
대화형 정리 증명은 깊은 주제입니다.
이 장은 Lean으로 프로그래밍할 때 실제로 나오는 증명을 지향하는 맛만 제공합니다.
