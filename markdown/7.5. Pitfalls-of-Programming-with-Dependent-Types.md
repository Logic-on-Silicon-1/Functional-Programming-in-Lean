...
Source: https://lean-lang.org/functional_programming_in_lean/Programming-with-Dependent-Types/Pitfalls-of-Programming-with-Dependent-Types

# 7.5. Pitfalls of Programming with Dependent Types[🔗](find/?domain=Verso.Genre.Manual.section&name=dependent-type-pitfalls "Permalink")
...
## 7.5.1. Definitional Equality[🔗](find/?domain=Verso.Genre.Manual.section&name=definitional-equality "Permalink")
...
## 7.5.2. Getting Stuck on Addition[🔗](find/?domain=Verso.Genre.Manual.section&name=stuck-addition "Permalink")
...
Getting it unstuck requires [propositional equality](Overloading-and-Type-Classes/Standard-Classes/#equality-and-ordering).

## 7.5.3. Propositional Equality[🔗](find/?domain=Verso.Genre.Manual.section&name=propositional-equality "Permalink")
...
## 7.5.4. Pros and Cons[🔗](find/?domain=Verso.Genre.Manual.section&name=dependent-types-pros-and-cons "Permalink")
...
## 7.5.5. Exercises[🔗](find/?domain=Verso.Genre.Manual.section&name=dependent-type-pitfalls-exercises "Permalink")
